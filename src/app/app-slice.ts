...
export const appSlice = createSlice({
  ...
  reducers: (create) => ({
    ...
    setCaptchaUrlAC: create.reducer<{ url: string | null }>((state, action) => {
      state.captchaUrl = action.payload.url
    }),
  }),
})

export const { changeThemeModeAC, setAppStatusAC, setAppErrorAC, setIsLoggedInAC, setCaptchaUrlAC } = appSlice.actions
